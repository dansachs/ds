...
class NoteParser extends parseBase_1.ParserBase {
    ...
    async parseFile(allPaths, vault) {
        const ctx = "parseFile";
        ...
        if (!rootProps.matchHash) {
            cacheUpdates[rootNote.fname] = utils_1.createCacheEntry({
                noteProps: rootNote,
        ...
        let prevNodes = fileMetaDict[1]
            ...
            if (!out.matchHash) {
                cacheUpdates[notes[0].fname] = utils_1.createCacheEntry({
                    noteProps: notes[0],
                    hash: out.noteHash,
                });
            }
    ...
    parseNoteProps(opts) {
        ...
        try {
            ...
            ({
                ...
                noteHash,
                matchHash,
            } = common_server_1.file2NoteWithCache({
            ...
            const err = common_all_1.DendronError.createFromStatus({
                ...
                payload: { fname: fileMeta.fpath, error: common_all_1.stringifyError(_err) },
