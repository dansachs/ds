...
class WorkspaceConfig {
    static write(wsRoot, vaults, opts) {
        ...
        return fs_extra_1.default.writeJSONSync(path_1.default.join(wsRoot, common_all_1.CONSTANTS.DENDRON_WS_NAME), jsonBody, { spaces: 2 });
    }
}
...
class Snippets {
    ...
    static write(dirPath, orig, changed) {
        ...
        const snippets = common_server_1.assignJSONWithComment(orig, changed);
        return common_server_1.writeJSONWithComments(snippetPath, snippets);
    }
}
...
Snippets.read = async (dirPath) => {
    ...
    if (!fs_extra_1.default.existsSync(snippetPath)) {
        ...
        return common_server_1.readJSONWithComments(snippetPath);
    }
};
class Settings {
    static getDefaults() {
