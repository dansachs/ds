...
export declare type CodeConfigChanges = {
    settings?: ConfigChanges;
    extensions?: CodeExtensionsConfig;
    snippetChanges?: any;
};
declare type CodeExtensionsConfig = {
    recommendations?: string[];
    unwantedRecommendations?: string[];
};
export declare type ConfigChanges = {
    add: [];
    errors: [];
};
declare type ConfigUpdateEntry = {
    /**
     * Config default
     */
    default: any;
...
export declare type ConfigUpdateChangeSet = {
    [k: string]: ConfigUpdateEntry;
};
export declare type SettingsUpgradeOpts = {
    force?: boolean;
};
export declare const _SETTINGS: ConfigUpdateChangeSet;
export declare type WriteConfigOpts = {
    vaults?: DVault[];
