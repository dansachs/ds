import { DendronConfig, DUser, DVault, DVaultSync, DWorkspace, DWorkspaceEntry, WorkspaceSettings } from "@dendronhq/common-all";
...
export declare class WorkspaceService {
    ...
    } & Parameters<WorkspaceService["addVault"]>[0]): Promise<void>;
    ...
    commitAndAddAll(): Promise<SyncActionResult[]>;
    /**
