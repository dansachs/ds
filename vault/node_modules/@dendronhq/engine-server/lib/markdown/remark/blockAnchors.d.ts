...
export declare function blockAnchor2htmlRaw(node: BlockAnchor, opts?: PluginOpts): string;
export declare function blockAnchor2html(node: BlockAnchor, opts?: PluginOpts): import("unist").Node;
