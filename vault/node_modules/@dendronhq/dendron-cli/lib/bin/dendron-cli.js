...
if (lodash_1.default.isUndefined(common_all_1.env("LOG_LEVEL", { shouldThrow: false }))) {
    process.env.LOG_LEVEL = "error";
}
let buildYargs = yargs_1.default;
new build_site_v2_1.BuildSiteV2CLICommand().buildCmd(buildYargs);
new build_site_v2_1.BuildSiteV2CLICommand("buildSite").buildCmd(buildYargs);
