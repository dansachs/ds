(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://dansachs.github.io/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://dansachs.github.io/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://dansachs.github.io/assets/css/just-the-docs-' + theme + ".css"
      );
    };
