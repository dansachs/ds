...
class MDUtilsV4 {
    ...
    static procFull(opts) {
        ...
        if (lodash_1.default.isUndefined(usePrettyRefs))
            usePrettyRefs = config_1.ConfigUtils.usePrettyRef(config);
        ...
        proc = proc
            ...
            .use(blockAnchors_1.blockAnchors, lodash_1.default.merge({ hideBlockAnchors: config.site.hideBlockAnchors }, opts.blockAnchorsOpts))
