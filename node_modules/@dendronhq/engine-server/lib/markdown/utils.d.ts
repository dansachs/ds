import { DendronConfig, DendronError, DEngineClient, DNoteLoc, DVault, GetNoteOpts, getSlugger, NotePropsDict, NoteProps } from "@dendronhq/common-all";
...
export declare const renderFromNoteWithCustomBody: (opts: {
    note: NoteProps;
    body: string;
}) => string;
...
export declare class MDUtilsV4 {
    ...
    static procDendronForPublish(opts: Omit<ProcDendron, "dest"> & {
        noteIndex: NoteProps;
    }): unified.Processor<unified.Settings>;
}
