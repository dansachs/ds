...
class FuseEngine {
    ...
    async updateSchemaIndex(schemas) {
        this.schemaIndex.setCollection(lodash_1.default.map(lodash_1.default.values(schemas), (ent) => common_all_1.SchemaUtils.getModuleRoot(ent)));
    }
    ...
    async removeSchemaFromIndex(smod) {
        this.schemaIndex.remove((doc) => {
            ...
            return doc.id === common_all_1.SchemaUtils.getModuleRoot(smod).id;
        });
    }
}
