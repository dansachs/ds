...
class DNodeUtils {
    ...
    static create(opts) {
        const { id, type, desc, links, anchors, fname, updated, created, parent, children, body, data, vault, } = lodash_1.default.defaults(opts, {
...
class NoteUtils {
    ...
    static createWikiLink(opts) {
        const { note, anchor, useVaultPrefix, useTitle } = lodash_1.default.defaults(opts, {
            useTitle: true,
        });
...
NoteUtils.RE_FM = /^---(.*)^---/ms;
NoteUtils.RE_FM_UPDATED = /^updated:.*$/m;
